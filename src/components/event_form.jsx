  ...
  render() {
    ...
    return (
      <div>
       ...
       <input type='text' name= 'restaurantAddress' placeholder="address" value={this.props.restaurantAddress}/>
       <input type='text' name= 'eventName' placeholder='Event Name' value={this.props.eventName}/>
       <input type='int' name= 'start' placeholder='Event Start' value={this.props.start}/>
